  ...
  static List<Map<String, dynamic>> groceryProducts = [
    {
      ...
      'quantity': 5,
      'image':
          'https://cdn.standardmedia.co.ke/images/wysiwyg/images/K95jKvNXMJikvYAhmdf2KoOBhENB3OirbpTr5E5X.jpg',
    ...
    },
    {
      ...
      'quantity': 1,
      'image':
          'https://www.backerhausveit.com/wp-content/uploads/2021/03/17783-2.jpg',
    ...
    },
    {
      ...
      'quantity': 3,
      'image':
          'https://www.allrecipes.com/thmb/Z5s08uvHYI2dg5LAd0vwoA47Ngo=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/240208_simplebakedchickenbreasts_mfs_step1_0181-1-4x3-250b3f145a194aa3bab88e94e3cbae73.jpg',
    ...
    },
    {
      ...
      'description':
          'Nutrient-rich broccoli, perfect for salads and stir-fries.'
    },
    {
      'id': 7,
      'name': 'Rice',
    ...
    },
    {
      ...
      'quantity': 6,
      'image':
          'https://www.marthastewart.com/thmb/dHImdd0qIZQDkHRJ6BkgW938P0U=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/GettyImages-1181862786-e6a2868c56b748ce81b52b56af57f4ac.jpg',
    ...
    },
    {
      ...
      'quantity': 1,
      'image':
          'https://www.tastingtable.com/img/gallery/the-best-type-of-butter-to-use-when-browning/intro-1686684813.jpg',
